"""T-074 클래스101(Class101) careers 어댑터 (Tier3 custom).

jobs.class101.net JSON API → RawJob list.
...
_CLASS101_API = "https://jobs.class101.net/api/jobs"
_REQUIRED_FIELDS = ("id", "title", "url")


class Class101Adapter(BaseCustomAdapter):
    """클래스101 careers 어댑터."""
    ...
    def __init__(
        self,
        company: str = "class101",
        *,
        client: Any | None = None,
        base_url: str | None = None,
    ) -> None:
        super().__init__(
            company=company, client=client, base_url=base_url or _CLASS101_API
        )
