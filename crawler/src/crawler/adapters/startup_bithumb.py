"""T-074 빗썸(Bithumb) careers 어댑터 (Tier3 custom).

bithumb-careers.com JSON API → RawJob list.
...
_BITHUMB_API = "https://bithumb-careers.com/api/jobs"
_REQUIRED_FIELDS = ("id", "title", "url")


class BithumbAdapter(BaseCustomAdapter):
    """빗썸 careers 어댑터."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            company=company, client=client, base_url=base_url or _BITHUMB_API
        )
