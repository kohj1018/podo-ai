"""T-074 트릿지(Tridge) careers 어댑터 (Tier3 custom).

careers.tridge.com JSON API → RawJob list.
...
_TRIDGE_API = "https://careers.tridge.com/api/jobs"
_REQUIRED_FIELDS = ("id", "title", "url")


class TridgeAdapter(BaseCustomAdapter):
    """트릿지 careers 어댑터."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            company=company, client=client, base_url=base_url or _TRIDGE_API
        )
