"""T-075 한화 그룹 채용포털 어댑터 (hanwhain.com).

한화시스템 포함. 목록 공개(list-public) — view_login=False.
"""
...
_HANWHA_API = "https://www.hanwhain.com/api/jobs"
_REQUIRED_FIELDS = ("id", "title", "url")


class HanwhaAdapter(BaseCustomAdapter):
    """한화 그룹 채용포털 어댑터."""
    ...
    def __init__(
        self,
        company: str = "hanwha-systems",
        *,
        client: Any | None = None,
        base_url: str | None = None,
    ) -> None:
        super().__init__(
            company=company, client=client, base_url=base_url or _HANWHA_API
        )
