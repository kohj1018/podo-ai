"""T-073 Amazon/AWS Jobs 어댑터 (Tier2 외국계 custom).

amazon.jobs/en/search?loc_query=South+Korea → RawJob list.
"""
...
_AMAZON_API = "https://www.amazon.jobs/en/search.json?loc_query=South+Korea&category[]=software-development"
_REQUIRED_FIELDS = ("id", "title", "url")


class AmazonAdapter(BaseCustomAdapter):
    """Amazon Jobs 어댑터 — loc_query=South Korea 필터."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            company=company, client=client, base_url=base_url or _AMAZON_API
        )
