"""T-075 KT 채용포털 어댑터 (recruit.kt.com).
...
_KT_API = "https://recruit.kt.com/api/jobs"
_REQUIRED_FIELDS = ("id", "title", "url")


class KTAdapter(BaseCustomAdapter):
    """KT 채용포털 어댑터."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(company=company, client=client, base_url=base_url or _KT_API)
