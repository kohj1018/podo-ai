"""T-074 두나무(Dunamu) careers 어댑터 (Tier3 custom).

careers.dunamu.com JSON API → RawJob list.
...
_DUNAMU_API = "https://careers.dunamu.com/api/jobs"
_REQUIRED_FIELDS = ("id", "title", "url")


class DunamuAdapter(BaseCustomAdapter):
    """두나무 careers 어댑터."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            company=company, client=client, base_url=base_url or _DUNAMU_API
        )
