"""T-076 토스뱅크 자체 채용사이트 어댑터 (Tier5 금융 custom).

toss.im/career JSON API → RawJob list.
토스 통합 career 페이지 사용(토스뱅크 = 토스 계열).
...
_BASE_URL = "https://toss.im/api/career/jobs"
_REQUIRED_FIELDS = ("id", "title", "url")


class TossBankAdapter(BaseCustomAdapter):
    """토스뱅크(토스 통합 career) 자체 채용사이트 어댑터."""
