...
## 3. 구현 항목
- `ai/worker/rank_aggregate.py`(T-003과 같은 모듈) — bradley_terry/elo/aggregate/RANKING_MODES/DOM_RANK.
...
## 4-1. 변경 예정 파일/경로
- `ai/worker/rank_aggregate.py`(aggregate/BT 부분), `ai/worker/tests/test_aggregate.py`
...
- write_set: ["ai/worker/rank_aggregate.py", "ai/worker/tests/test_aggregate.py"]
